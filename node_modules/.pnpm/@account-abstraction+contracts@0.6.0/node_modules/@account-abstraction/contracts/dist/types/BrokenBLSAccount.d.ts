...
export interface BrokenBLSAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "aggregator" | "entryPoint" | "execute" | "executeBatch" | "getBlsPublicKey" | "getDeposit" | "getNonce" | "initialize(address)" | "initialize(uint256[4])" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "owner" | "proxiableUUID" | "supportsInterface" | "tokensReceived" | "upgradeTo" | "upgradeToAndCall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
