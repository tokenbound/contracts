...
export interface VerifyingPaymasterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addStake" | "deposit" | "entryPoint" | "getDeposit" | "getHash" | "owner" | "parsePaymasterAndData" | "postOp" | "renounceOwnership" | "senderNonce" | "transferOwnership" | "unlockStake" | "validatePaymasterUserOp" | "verifyingSigner" | "withdrawStake" | "withdrawTo"): FunctionFragment;
...
export interface VerifyingPaymaster extends BaseContract {
    ...
    functions: {
        ...
        getHash(userOp: UserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        getHash(userOp: UserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getHash(userOp: UserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
